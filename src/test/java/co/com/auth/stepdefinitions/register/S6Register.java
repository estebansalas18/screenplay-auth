...
public class S6Register {
    ...
    public void queElUsuarioAccedeALaPaginaDeRegistro6() {
    ...
    public void ingresaTodosLosDatosRequeridosEnElFormularioExceptoSuEmailIncluyendoDominioCom6()
    ...
    public void elSistemaNoDebePermitirAlUsuarioRegistrarse6() throws InterruptedException {
    ...
    public void elSistemaDebeMostrarUnMensajeDeErrorQueIndiqueIngresarElEmailConDominioCom6()
            throws InterruptedException {
        this.user.attemptsTo(VerifyRegister.withMessage("El campo email no cumple con el formato adecuado"));
        Thread.sleep(1000);
    }
}
