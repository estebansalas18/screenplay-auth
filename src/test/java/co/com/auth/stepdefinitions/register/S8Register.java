...
public class S8Register {
    ...
    public void queElUsuarioAccedeALaPaginaDeRegistro8() {
    ...
    public void ingresaTodosLosDatosRequeridosEnElFormularioConUnaFechaDeNacimientoPosteriorALaFechaActual8()
    ...
    public void elSistemaNoDebePermitirAlUsuarioRegistrarse8() throws InterruptedException {
    ...
    public void elSistemaDebeMostrarUnMensajeDeErrorQueIndiqueNoValidarElRegistroConUnaFechaNacimientoPosteriorALaFechaActual8()
            throws InterruptedException {
        this.user.attemptsTo(VerifyRegister.withMessage("La fecha de nacimiento no puede ser mayor a la fecha actual"));
        Thread.sleep(1000);
    }
}
